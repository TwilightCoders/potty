...
RSpec.describe Cursed::Widgets::Container do
  ...
  describe Cursed::Widgets::VBox do
  ...
  describe Cursed::Widgets::HBox do
  ...
  describe 'focus traversal' do
    it 'collects focusable leaves depth-first across nesting' do
      ...
      outer = Cursed::Widgets::VBox.new(app).add(f1, inner)
  ...
  describe 'recursion' do
    it 'propagates tick to children' do
      ...
      Cursed::Widgets::VBox.new(app).add(leaf_a).tick(:t)
